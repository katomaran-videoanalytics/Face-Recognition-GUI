...
class App:
    def __init__(self, window, window_title):
       ...
       # Create a canvas that can fit the above video source size
        ...
        #self.canvas2 = tkinter.Canvas(window, width = 100, height = 100)
        #self.canvas2.grid(column =5, row =10)
        #self.photo = ImageTk.PhotoImage(file=Image.fromarray('per.jpg'))
...
class MyVideoCapture:
    ...
    def get_frame(self):
        if self.vs.isOpened():
            ...
            cv2.line(frame, (0, self.H-290), (self.W, self.H-290), (0, 255, 255), 2)
